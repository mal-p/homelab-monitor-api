    ...
    #[OA\RequestBody(
        ...
        content: new OA\JsonContent(
            ...
            properties: [
                ...
                new OA\Property(property: 'location_id', type: 'integer', nullable: true, example: 7),
                new OA\Property(property: 'description', type: 'string', nullable: true, maxLength: 2000, example: ''),
                new OA\Property(property: 'is_active', type: 'boolean', example: true),
            ],
        ),
    )]
                    ...
                    properties: [
                        ...
                        new OA\Property(
                            ...
                            properties: [
                                ...
                                new OA\Property(property: 'description', type: 'string', example: 'Upstairs front bedroom'),
                            ],
                        ),
